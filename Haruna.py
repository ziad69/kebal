...
helpMessage ="""||=====  P U B L I C  =====||
???Åô? Creator = Melihat Pembuat Bot
???Åô? Haruna say = Mengikuti Apa Yang DiKatakan
???Åô? Gcreator = Check Creator Grup

||=====  O W N E R  =====||
???Åô? Admin add @ = Menambahkan Admin
???Åô? Admin remove @ = Menghapus Admin
???Åô? Adminlist = Cek Admin
...
Only Admin Can Control This Bot
"""
KAC=[cl,ki,kk,kc]
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Selamat datang di Grup,Senpai ®R?®Q")
					kk.sendText(msg.to,"Jangan nakal ya,Senpai ®R?®Q")
#-----------------------------------------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					start = time.time()
					cl.sendText(msg.to, "Wait,Senpai®R?®Q")
